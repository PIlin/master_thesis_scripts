...
set namtracename    t5.nam

set ns        		[new Simulator]
set tracefd       	[open t5.tr w]
...
for {set i 0} {$i < $val(nn) } { incr i } {
        ...
        set mac [ [set mnode_($i)] getMac 0]
        puts $mac
        set ll [$mac up-target]
        puts $ll
        $ll set GTS_delivery_ 1
}
...
$ns at $val(assocStart) "$mnode_(0) sscs MLME_GTS_indication 0 [expr {0xFE}]"
